                ...
                <div class="col-sm-12 owl-slider-1">
                    <div class="owl-carousel" data-margin="0" data-loop="yes" data-nav="yes" data-dots="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
                        ...
                        <div class="img-slider-1">
                                <a href="#"><img src="admin/uploads/mainslider/<?php echo $slider['logo']; ?>" alt=""></a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
...
<a href="product.php?id=<?=$new_product['id']?>" class="product-img"><img src="admin/uploads/product/<?php echo $new_product['image']; ?>" alt=""></a>
<!--Sale Label-->
...
<div class="caption">
<h4><a href="product.php?id=<?=$new_product['id']?>"><?php echo $new_product['name']; ?></a></h4>		
<div class="ratings">
