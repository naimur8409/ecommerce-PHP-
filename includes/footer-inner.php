									...
									<div class="module clearfix">
										...
										<div class="modcontent">
											<ul class="contact-address">
												<li><p><span class="fa fa-map-marker"></span><span>Address : </span> Demo</p></li>
												<li><span class="fa fa-envelope-o"></span><span>Email : </span> <a href="#"> amaz@gmail.com</a></li>
								...
								<div class=" container">
									<div class=" row">
										<div class="footer-mid-left col-sm-6 col-xs-12">
											<h3>NEED HELP? </h3>
											<p>SUPPORT TEAM 24/7 AT 01478552</p>
										</div>
